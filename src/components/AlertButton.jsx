        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <span className={`font-bold tracking-wider ${currentTheme.muted}`}>
               ALERTS
              </span>
          ...
          {!events.length ? (
            ...
            <div className={`p-4 text-sm ${currentTheme.text}`}>
              NO EVENTS RECORDED.
            </div>
              ...
              {events.map((event, index) => (
                ...
                >
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className={`${currentTheme.text} text-xs`}>
                      {event.score ?? 0}
                    </span>

                  </div>

                  <div className={`${currentTheme.text} text-xs mt-1`}>
                   Path:  {event.path}
                  </div>
